...
local Systems = StarterPlayer:WaitForChild("StarterPlayerScripts"):WaitForChild("Systems", 5)
local Services = StarterPlayer:WaitForChild("StarterPlayerScripts"):WaitForChild("Services", 5)
